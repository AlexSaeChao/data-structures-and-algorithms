...
const validateWord = (word) => {
  // Solution code here...
  const validation = /^\D{5,10}$/;
  return validation.test(word);
};
...
const hasNumber = (string) => {
  // Solution code here...
  let hasANumber = /[a-zA-Z]\d/;
  return hasANumber.test(string);
};
...
const validateEmail = (email) => {
  // Solution code here...
  let validation = /^[a-zA-Z0-9]+(\.[a-zA-Z0-9]+)?@[a-zA-Z0-9]+\.(com|net|org)$/;
