...
const maxInArray = (arr) => {
  // Solution code here...
  return arr.reduce((maxVal, currentVal) => {
...
const checkValues = (obj, value) => {
  // Solution code here...
  let hasValues = Object.values(obj);
  return hasValues.includes(value);
};
...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  let characterName = arr.find((obj) => obj.name === character);

  if (characterName) {
    let values = Object.values(characterName);
    return values.includes(characterName.children);
  }
